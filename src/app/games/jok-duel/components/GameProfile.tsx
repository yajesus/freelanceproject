          ...
          >
            ...
            >
              ...
              <div className='absolute left-1/2 -translate-x-1/2 top-1/4 w-[80%] flex flex-col items-center text-[13px]'>
                ...
                {/* <div className='flex gap-[10px] w-[60%] items-center'>
                  <svg
                    width='23'
                    height='24'
                    viewBox='0 0 23 24'
                  ...
                  >
                    <path
                      d='M20.9925 10.7533C18.8652 13.7895 14.4398 20.1875 12.3424 23.187C11.7437 24.0478 10.3926 23.5551 10.4899 22.5109L11.1511 15.379C11.2072 14.7815 10.7357 14.265 10.1356 14.265C-1.82809 14.256 1.78189 15.9856 4.81968 1.43293C4.93595 0.982768 5.34266 0.667114 5.808 0.667114H15.2939C15.9626 0.667114 16.4504 1.30087 16.2794 1.94832L14.7126 7.86896C14.5417 8.51642 15.0294 9.15016 15.6981 9.15016H20.1554C20.9788 9.15028 21.4629 10.0772 20.9925 10.7533Z'
                      fill='#4ECDEA'
                    />
                    <path
                      d='M16.0374 17.8778L12.3472 23.1821C11.7485 24.0429 10.3974 23.5502 10.4947 22.5061L11.1558 15.3741C11.212 14.7766 10.7404 14.2601 10.1404 14.2601H2.84379C2.1776 14.2601 1.68987 13.6313 1.85571 12.9863L4.82471 1.42829C5.04111 0.179518 7.54685 0.80262 8.35758 0.662358L6.66477 9.05679C6.46013 10.0697 7.23487 11.0167 8.26909 11.0167H13.0332C14.1348 11.0167 14.922 12.0833 14.5963 13.1361L13.7855 15.7584C13.3792 17.2245 14.6999 18.0822 16.0374 17.8778Z'
                      fill='#4F9CE8'
                    />
                  </svg>
                  <div className='flex justify-between w-full'>
                    <p>Energy</p>
                    <p>{gameUser.energy}/50</p>
                  </div>
                </div> */}
              ...
              >
                <button
                  ...
                  className="h-[7%] w-[40%] flex items-center justify-center absolute left-1/2 transform -translate-x-1/2 bottom-[25%] text-[80%]"
                >
                  <svg
                    width="21"
                    height="25"
                  ...
                  >
                    <path
                      d="M19.9221 11.021C17.7304 14.1492 13.1708 20.7411 11.01 23.8315C10.3931 24.7183 9.00105 24.2106 9.1013 23.1349L9.78249 15.7869C9.84037 15.1712 9.35451 14.6391 8.73624 14.6391C-3.58984 14.6299 0.129498 16.4118 3.25931 1.41835C3.37911 0.954549 3.79814 0.629333 4.27758 0.629333H14.0509C14.7398 0.629333 15.2424 1.28228 15.0662 1.94936L13.4519 8.04935C13.2759 8.71642 13.7784 9.36936 14.4673 9.36936H19.0596C19.908 9.36949 20.4067 10.3245 19.9221 11.021Z"
                      fill="#4ECDEA"
                    />
                    <path
                      d="M14.8169 18.3629L11.0149 23.828C10.398 24.7148 9.00602 24.2072 9.10627 23.1314L9.78747 15.7834C9.84535 15.1678 9.35948 14.6356 8.74121 14.6356H1.2236C0.537235 14.6356 0.0347243 13.9879 0.20559 13.3233L3.26454 1.41513C3.48748 0.128523 6.06914 0.770501 6.90443 0.62599L5.16033 9.27472C4.94949 10.3183 5.74771 11.294 6.81326 11.294H11.7217C12.8566 11.294 13.6677 12.3929 13.3322 13.4777L12.4967 16.1794C12.0782 17.6899 13.4388 18.5735 14.8169 18.3629Z"
                      fill="#4F9CE8"
                    />
                  </svg>
                  <p>Get energy</p>
