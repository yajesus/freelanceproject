  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className='absolute bottom-2 right-[11px] animate-horizontal-shake'
          onClick={() => startGame()}
        >
          <div className='relative'>
            ...
            />
            <div className='animate-blinkLonger w-24 h-[5px] left-[3px] top-[38px] absolute bg-gradient-to-r from-[#C27CBC] via-[#D3FF00] to-[#3BE32D] z-10 blur-[6px]' />
