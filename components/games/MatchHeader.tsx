  ...
  return (
    <div className="flex flex-col gap-8 z-999 relative" ref={menuRef}>
        ...
        <div className="flex justify-center items-center gap-9">
          ...
          <div className="relative">
            <div className="bg-gradient-to-tr from-[#C27CBC] via-[#D3FF00] to-[#3BE32D] p-[1px] rounded-r-xl">
              <div className="bg-black rounded-r-xl ml-1 px-5 py-2 justify-start text-white text-base text-[16px] font-normal lowercase leading-3">
                {totalStars}
              </div>
            </div>
            <div className="absolute -top-[2px] -left-4">
              <Image
                priority={true}
                src={star2}
                alt={""}
      ...
      {showTabs && <div className="flex items-center gap-2.5 z-999">
        <div className="flex-1 flex justify-between items-center bg-neutral-900 rounded-[10px]">
          <div
